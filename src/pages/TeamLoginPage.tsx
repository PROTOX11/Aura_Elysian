...
const TeamLoginPage: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const response = await fetch(`${import.meta.env.VITE_SERVER_URL}/api/team/login`, {
                method: 'POST',
            ...
            >
                ...
                >
                    <p className="text-sm text-gray-600">
                        ...
                        <a href="/team/signup" className="font-medium text-pink-600 hover:text-pink-500 transition-colors duration-200">
                            Sign up
                        </a>
                    </p>
                </motion.div>
