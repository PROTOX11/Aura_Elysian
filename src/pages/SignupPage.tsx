            ...
            >
                <div className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-lg p-8 md:p-12">
                    <div className="text-center mb-8">
                        <h1 className="font-serif text-4xl font-bold text-gray-900 mb-2">Create Account</h1>
                    ...
                    <motion.div variants={fadeInUp} className="text-center mt-8">
                        <p className="text-gray-600">
                            ...
                            <Link to="/login" className="font-semibold text-purple-600 hover:text-purple-800 transition-colors">
                                Sign In
                            </Link>
                        </p>
                    </motion.div>
