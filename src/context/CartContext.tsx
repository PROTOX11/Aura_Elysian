...
export const CartProvider: React.FC<CartProviderProps> = ({ children }) => {
    ...
    const fetchCart = async () => {
        ...
        try {
            ...
            // The response is an array of carts, we need to flatten it
            const cartItems = response.data.flatMap((c: any) => c.products);
            setCart(cartItems);
        } catch (error) {
        ...
        try {
            ...
            setCart(prevCart => {
                ...
                if (itemIndex > -1) {
                    ...
                    // This part is tricky without full product info. 
                    // The component calling this should handle adding new items.
                    // For now, we assume the item exists for quantity updates.
                }
                return prevCart;
            });
