    ...
    <div className="flex items-center gap-3">
      ...
      {showText && (
        <div className="flex flex-col leading-tight">
          <span className="font-serif text-lg font-semibold bg-gradient-to-r from-gold-600 via-purple-700 to-pink-400 bg-clip-text text-transparent">
            Aura Elysian
          </span>
          <span className="font-serif text-xs text-gray-800 -mt-1">Luxury Candles</span>
        </div>
      )}
    </div>
  );
